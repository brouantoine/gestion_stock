# Generated by Django 5.2 on 2025-07-22 23:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('montant_ventes_directes', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
                ('montant_commandes', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_permissions', models.ManyToManyField(blank=True, related_name='utilisateurs_custom', to='auth.permission', verbose_name='Permissions personnalisées')),
            ...
            options={
                ...
                'permissions': [('manage_users', 'Peut gérer les utilisateurs'), ('reset_password', 'Peut réinitialiser les mots de passe'), ('change_role', 'Peut modifier les rôles')],
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('VALIDEE', 'Validée par le client')], default='VALIDEE', max_length=20)),
                ('est_payee', models.BooleanField(default=True)),
                ('remise', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('total_commande', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
                ('notes', models.TextField(blank=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='commandes', to='api.client')),
                ('utilisateur', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='commandes_client', to=settings.AUTH_USER_MODEL)),
                ('tva', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.PROTECT, to='api.taxe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code_commande', models.CharField(editable=False, max_length=20, unique=True)),
                ('type_produit', models.CharField(max_length=50)),
                ('date_creation', models.DateTimeField(auto_now_add=True)),
                ('date_validation', models.DateTimeField(blank=True, null=True)),
                ('statut', models.CharField(choices=[('BROUILLON', 'Brouillon'), ('VALIDEE', 'Validée'), ('LIVREE', 'Livrée'), ('ANNULEE', 'Annulée')], default='BROUILLON', max_length=20)),
                ('notes', models.TextField(blank=True)),
                ('utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='commandes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_livraison', models.CharField(choices=[('A_LIVRER', 'À livrer'), ('PARTIELLE', 'Livraison partielle'), ('LIVREE', 'Livrée')], default='A_LIVRER', max_length=20)),
                ('total_ligne_ht', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('commande', 'produit', 'prix_unitaire', 'remise_ligne'), name='unique_ligne_commande')],
            },
        ),
